...
const pagosVencidos = [
    { nombre: 'Odry Hernandez', atraso: '12 días de atraso', monto: '$580' },
    { nombre: 'Emiliano Ayala', atraso: '5 días de atraso', monto: '$520' },
    { nombre: 'Josue Rivera', atraso: '18 días de atraso', monto: '$1160' },
    { nombre: 'Mauricio Rivera', atraso: '3 días de atraso', monto: '$500' },
];
</script>
...
<template>
    <GymLayout>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="mb-10 bg-red-950/20 border border-red-900/40 rounded-2xl overflow-hidden shadow-2xl">
                <div class="p-4 bg-red-900/20 border-b border-red-900/30 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-red-400/70 text-xs">4 clientes tienen pagos pendientes</p>
                    </div>
                </div>
                
                <div class="divide-y divide-red-900/20">
                    <div v-for="pago in pagosVencidos" :key="pago.nombre" class="p-4 flex justify-between items-center hover:bg-red-900/10 transition-all">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-[10px] text-red-900 font-black uppercase">MXN</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-gym-card-bg border border-gym-gray-border p-6 rounded-2xl shadow-xl">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <h2 class="text-3xl font-black text-white">87</h2>
                        </div>
                    </div>
                    <div class="w-full bg-gym-gray-border rounded-full h-2">
                        <div class="bg-gym-green h-2 rounded-full shadow-[0_0_8px_rgba(0,168,120,0.5)]" style="width: 87%"></div>
                    </div>
                </div>
                ...
                <div class="bg-gym-card-bg border border-gym-gray-border p-6 rounded-2xl shadow-xl">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <h2 class="text-3xl font-black text-white">12</h2>
                        </div>
                    </div>
                    <div class="w-full bg-gym-gray-border rounded-full h-2">
                        <div class="bg-gym-gray-text/20 h-2 rounded-full" style="width: 12%"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gym-card-bg border border-gym-gray-border p-6 rounded-2xl shadow-xl flex justify-between items-center">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <h2 class="text-4xl font-black text-white">99</h2>
                    </div>
                </div>
                <div class="text-right">
                    <p class="text-gym-gray-text text-xs font-bold uppercase mb-1">Tasa de actividad</p>
                    <p class="text-gym-green text-3xl font-black">88%</p>
                </div>
            </div>
        </div>
    </GymLayout>
